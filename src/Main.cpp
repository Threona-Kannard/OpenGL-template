...
int main()
{
    ...
    if (!createWindow(window, SCR_WIDTH, SCR_HEIGHT, "LearnOpenGL"))
    {
    ...
    // ------------------------------------
    Shader ourShader(vertexPath, fragmentPath, nullptr); // you can name your shader files however you like
